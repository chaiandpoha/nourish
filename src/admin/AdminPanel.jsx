      ...
      <div style={{ ...s.card, border:'1px solid rgba(200,80,64,0.3)' }}>
        <div style={{ padding:'16px', display:'flex', flexDirection:'column', gap:'12px' }}>
          ...
          <p style={{ fontSize:'13px', color:'var(--text-secondary)', margin:0 }}>
            Wipes ALL data from this device. Your profile and household data will restore from the cloud on next sign-in.
          </p>
...
const s = {
  ...
  avatar:         { width:'38px', height:'38px', borderRadius:'50%', background:'var(--accent)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:'13px', fontWeight:'600', color:'var(--text-inverse)', flexShrink:0 },
  ...
  saveBtn:        { width:'100%', padding:'10px', background:'var(--accent)', border:'none', borderRadius:'var(--r-md)', color:'var(--text-inverse)', fontSize:'14px', fontWeight:'600', cursor:'pointer' },
