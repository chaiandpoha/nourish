...
const s = {
 container: { display:'flex', flexDirection:'column', height:'calc(100dvh - 80px)', background:'var(--bg-base)' },
  ...
  bubbleTextUser:      { background:'var(--accent)', color:'var(--text-inverse)', borderBottomRightRadius:'4px' },
  ...
  mealPickerBtnActive: { background:'var(--accent)', color:'var(--text-inverse)', fontWeight:'600' },
  ...
  sendBtn:      { width:'40px', height:'40px', borderRadius:'50%', background:'var(--accent)', border:'none', color:'var(--text-inverse)', fontSize:'18px', fontWeight:'700', cursor:'pointer', display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0 },
}