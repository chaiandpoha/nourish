...
const s = {
  ...
  tabActive:     { background:'var(--accent)', color:'var(--text-inverse)', border:'0.5px solid var(--accent)' },
  ...
  label:         { fontSize:'12px', fontWeight:'600', color:'var(--accent)', textTransform:'uppercase', letterSpacing:'0.08em' },
  ...
  btn:           { padding:'13px', background:'var(--accent)', border:'none', borderRadius:'var(--r-lg)', color:'var(--text-inverse)', fontSize:'15px', fontWeight:'600', cursor:'pointer', flex:1 },
  ...
  sectionLabel:  { fontSize:'11px', fontWeight:'700', color:'var(--accent)', textTransform:'uppercase', letterSpacing:'0.08em', paddingTop:'4px' },
  ...
  memberAvatar:  { width:'36px', height:'36px', borderRadius:'50%', background:'var(--accent)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:'13px', fontWeight:'600', color:'var(--text-inverse)', flexShrink:0 },
