...
const s = {
  ...
  sheet:        { position:"fixed", bottom:0, left:0, right:0, background:"var(--bg-surface)", borderRadius:"22px 22px 0 0", borderTop:"0.5px solid var(--border-subtle)", padding:"12px 16px calc(16px + env(safe-area-inset-bottom))", zIndex:151, height:"92svh", overflowY:"auto", overscrollBehavior:"contain", WebkitOverflowScrolling:"touch", animation:"sheetUp 0.3s cubic-bezier(0.16,1,0.3,1) both" },
